 ...
 * than pull in @expo/vector-icons — keeps the bundle dependency-free and the
...
const PATHS: Record<IconName, string[]> = {
  ...
  logout: ['M14 5h3.5A1.5 1.5 0 0 1 19 6.5v11a1.5 1.5 0 0 1-1.5 1.5H14', 'M10 12H3.5', 'M6.5 8 3 12l3.5 4'],
