...
const BankDashboard: React.FC = () => {
    ...
    const { createMintRequest, bankConfirm, getNeedBankConfirm } = useMint(signer)
    ...
    const loadRequests = async () => {
        setLoading(true)
        try {
            const reqs = await getNeedBankConfirm()
            setRequests(reqs)
        } catch (e) {
            console.error(e)
        }
        ...
        <Box p={8} bg="gray.50" minH="100vh">
            ...
            <Stack direction={{ base: 'column', md: 'row' }} spacing={8} align="flex-start">
                ...
                <Card w={{ base: '100%', md: '40%' }} shadow="lg" borderRadius="2xl">
                    <CardHeader>
                        <Heading size="md">Create Bank Request</Heading>
                    </CardHeader>
                    <CardBody>
